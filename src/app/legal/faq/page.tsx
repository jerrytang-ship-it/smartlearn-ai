...
const faqs = [
  {
    q: "智學AI係咩？",
    a: "智學AI係一個專為香港10-13歲學生設計嘅AI素養學習應用程式，用Duolingo-style遊戲化方式教小朋友認識人工智能。",
  },
  {
    q: "我需要登入先可以用嗎？",
  ...
  {
    q: "每日挑戰係咩？",
    a: "每日挑戰係每日更新嘅特別題目，四個類別輪流出現（AI in、AI歷史、我係邊個AI？、搵出唔同嗰個）。每日完成可以獲得連續天數！",
  },
  {
    q: "我答錯咗題目會點？",
  ...
  {
    q: "排行榜上會顯示我嘅真實名字嗎？",
    a: "唔會！排行榜只會顯示你嘅暱稱（例如「快樂海豚#42」），唔會顯示你嘅Google名或電郵。",
  },
  {
    q: "我嘅資料安全嗎？",
    a: "我哋使用 Supabase 雲端服務儲存資料，符合國際安全標準。詳情請參閱我哋嘅私隱政策。",
  },
  {
    q: "點樣刪除我嘅帳戶？",
